...
import com.example.washinton.feature.batches.RegisterBatchScreen
...
import com.example.washinton.feature.profile.ProfileScreen
...
fun MainApp(modifier: Modifier = Modifier) {
    ...
    Surface (modifier = Modifier.fillMaxSize())
    {
        ...
        NavHost(navController = navController, startDestination = start) {
            ...
            composable("batches"){
                RegisterBatchScreen(navController)
            }
        }
    }
}
